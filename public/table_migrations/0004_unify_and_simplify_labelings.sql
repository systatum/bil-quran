ALTER TABLE "chapters" ADD COLUMN "readings" jsonb DEFAULT '{}'::jsonb NOT NULL;--> statement-breakpoint
ALTER TABLE "chapters" ADD COLUMN "meanings" jsonb DEFAULT '{}'::jsonb NOT NULL;--> statement-breakpoint
